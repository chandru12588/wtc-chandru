...
export default function BookingForm({ pkg, containerClassName = "" }) {
  ...
  const renderUploadField = ({
    ...
    <div className="min-w-0 rounded border p-3">
      ...
      <label
        htmlFor={inputId}
        className="mt-3 inline-flex cursor-pointer items-center rounded-md bg-stone-100 px-3 py-2 text-sm font-medium text-stone-700 transition hover:bg-stone-200"
      >
        Choose File
      </label>
