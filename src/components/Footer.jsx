...
/* IMPORT MULTIPLE INSTAGRAM IMAGES */
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-4">
            <a href="https://www.instagram.com/wrongturnclub/?utm_source=qr&r=nametag" target="_blank" rel="noopener noreferrer" className="hover:text-pink-400">
              <Instagram size={18} />
            </a>
            <a href="https://www.facebook.com/search/top?q=wrong%20turn%20club" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">
              <Facebook size={18} />
            </a>
            <a href="https://www.youtube.com/watch?v=JC41sopCd3E" target="_blank" rel="noopener noreferrer" className="hover:text-red-400">
              <Youtube size={18} />
            </a>
            <a href="https://maps.app.goo.gl/7n3auWptfisBCiiDA" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400">
              <MapPin size={18} />
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link to="/trips" className="hover:text-white">Trips</Link></li>
            <li><Link to="/host/register" className="hover:text-white">Become a Host</Link></li>
        ...
        <div>
          ...
          <iframe
            ...
            className="w-full h-44 md:h-56 rounded-xl border border-white/10 shadow-lg"
            loading="lazy"
